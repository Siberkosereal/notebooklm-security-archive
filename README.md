...
| 04 | `04_tüm_linux.txt` / `tüm_linux.md` | Linux Systems Guide | [Official Site](https://www.linuxdersleri.net/) |
...
| 09 | `cyber-security.pdf` | **Roadmap.sh** | [Cyber Security Roadmap](https://roadmap.sh/cyber-security) |
...
| 13 | **Custom Converter Tools** | Siberkosereal | [HTML-to-MD](https://github.com/Siberkosereal/HTML-to-Markdown-Converter) / [HTML-Merger](https://github.com/Siberkosereal/HTML-Document-Merger) |
